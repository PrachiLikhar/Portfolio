    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Prachi Likhar</p>
            <p className="subtext">
              During my academic years, I focused on building strong frontend
              and backend development skills to create dynamic and user-friendly
              web applications.
            </p>
          </div>
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              Located in India, comfortable working across different time zones.
            </p>
          </div>
